...
## [2026年1月6日](/ja/releases/release-notes/2026-01-06)

**Playground と Tasks の一般公開後の改善**

Playground と Tasks の一般公開後の改善を実施しました。ワークフローデザイナーから直接アプリを選択して Playground で実行できるようになり、タスク入力が展開可能な形式で表示されるようになりました。
