...
## [2026年2月20日](/ja/releases/release-notes/2026-02-20)

**Data Stores & Data Query、Claude Opus 4.6**

外部の PostgreSQL データベースをワークフローに接続する Data Stores と Data Query ノードを導入。1M コンテキストウィンドウと 128k 出力トークンを持つ Anthropic の最もインテリジェントなモデル Claude Opus 4.6 を追加。複数の CVE 修正とセキュリティ強化。

---

## [2026年1月22日](/ja/releases/release-notes/2026-01-22)

**GPT-5.2 Codex、Playground & Tasks の改善**

コード特化ワークフロー向けの GPT-5.2 Codex モデルを追加。Playground でワークフローデザイナーから直接アプリを選択して実行可能に。Tasks ページに入力値の展開表示を追加。GitHub Trigger の実行中コメント投稿を制御可能に。Node.js を 22 から 24 にアップグレード。

---

## [2025年12月24日](/ja/releases/release-notes/2025-12-24)
...
## [2025年12月23日](/ja/releases/release-notes/2025-12-23)
