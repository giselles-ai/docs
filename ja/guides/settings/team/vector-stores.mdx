...
1. **GitHub アカウントの認証**: [アカウント設定の認証ページ](/settings/account/authentication)で GitHub アカウントを接続
2. **GitHub App のインストール**: [Integrations 設定](/settings/team/integrations)で Giselle の GitHub App をインストール
