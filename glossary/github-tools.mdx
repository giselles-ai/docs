...
Lists security vulnerabilities found by code scanning with filters for severity, state, and tool
- **Required**:
  - `owner` (Repository owner)
  - `repo` (Repository name)
- **Optional**:
  ...
  - `toolName` (Name of the scanning tool)
  - `ref` (Git reference for results)

#### `getCodeScanningAlert`
Gets details about a specific code scanning alert by number
- **Required**:
  - `owner` (Repository owner)
  - `repo` (Repository name)
