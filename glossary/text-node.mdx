# Text Node
Source: https://docs.giselles.ai/glossary/text-node
...
*   **Automatic JSON Formatting**: If you input valid JSON, the Text Node will automatically detect and format it, making it easy to work with structured data.
