...
| gemini-2.5-flash-lite-preview-06-17 | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | 1M tokens | Free |
...
**Free Plan Models:**
* **For the latest extremely fast responses and efficiency (preview)**: `gemini-2.5-flash-lite-preview-06-17` (Newer maximum speed)
...
For users prioritizing speed on the Free plan, the new `gemini-2.5-flash-lite-preview-06-17`, `gemini-2.0-flash` and `gemini-2.0-flash-lite` are excellent options. Pro users seeking a balance of speed and reasoning might consider the `gemini-2.5-flash-preview-05-20`.
