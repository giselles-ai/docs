...
<Steps>
  ...
  <Step title="Build Agent">
    <AccordionGroup>
      ...
      <Accordion title="Place a Node and Test it">
      ...
      <Accordion title="Run a Test Drive of Your Agent">
  ...
  <Step title="Run Agent as Workflow">
    <AccordionGroup>
      ...
      <Accordion title="Run the Agent as a Workflow">
