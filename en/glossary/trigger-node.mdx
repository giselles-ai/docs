---
title: Trigger Node
description: Learn about Trigger Nodes, the starting points for workflows in Giselle. Use GitHub Triggers to initiate your AI workflow sequences.
---
...
5a. **Configure In-Progress Comment (Optional)**:
