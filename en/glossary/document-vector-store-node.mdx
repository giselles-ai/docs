---
title: 'Document Vector Store Node'
description: 'Learn how the Document Vector Store Node enables you to upload and search documents using vector embeddings for AI-powered retrieval in your Giselle workflows.'
---

Learn how the Document Vector Store Node in Giselle enables Retrieval-Augmented Generation (RAG) by allowing you to upload documents, process them into searchable vector embeddings, and query them within your AI workflows.
