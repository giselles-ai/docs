...
## [February 20, 2026](/en/releases/release-notes/2026-02-20)

**Data Stores & Data Query, Claude Opus 4.6**

Introducing Data Stores and Data Query nodes for connecting external PostgreSQL databases to your workflows. Added Claude Opus 4.6, Anthropic's most intelligent model with 1M context window and 128k output tokens. Multiple CVE fixes and security enhancements.

---

## [January 22, 2026](/en/releases/release-notes/2026-01-22)

**GPT-5.2 Codex, Playground & Tasks Improvements**

Added GPT-5.2 Codex model for code-focused workflows. Playground now supports app selection directly from the workflow designer. Tasks page features expandable input display. New control for GitHub Trigger in-progress comment posting. Node.js upgraded from 22 to 24.
