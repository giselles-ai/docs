...
## [January 6, 2026](/en/releases/release-notes/2026-01-06)

**Playground & Tasks Post-GA Improvements**

Improvements to Playground and Tasks following their general availability. You can now select an app directly from the workflow designer to run it in Playground, and task inputs are displayed in an expandable format for easier review.
