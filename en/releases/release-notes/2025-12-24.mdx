...
- **[Playground](/en/guides/playground)** — A dedicated page for running your apps without entering the workspace editor. Simply select an app and execute it with a streamlined interface focused on input and output.
- **[Tasks](/en/guides/tasks)** — A comprehensive execution history page where you can view all your workflow runs with clear status indicators and detailed results.
