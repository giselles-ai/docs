...
Each plan has limits on the number of Document Vector Stores you can create.

### Quotas by Plan

| Plan | Document Vector Stores |
|------|----------------------|
| Free | Unavailable          |
| Pro  | Up to 5              |
| Team | Up to 20             |

Document Vector Stores allow you to upload PDF, TXT, and Markdown files to build knowledge bases that can be utilized in your AI workflows.
...
- **Free Plan**: To use Document Vector Stores, you need to upgrade to Pro or Team plan
- **Pro Plan**: When you reach the 5-store limit, you can delete existing Vector Stores or consider upgrading to Team plan
- **Team Plan**: When you reach the 20-store limit, you need to delete existing Vector Stores
