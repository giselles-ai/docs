  ...
  <Step title="Build an Agent">
    <AccordionGroup>
      <Accordion title="Create an Agent" defaultOpen={true}>
        ...
        <Frame>
          <img src="/en/images/quickstart/new-agent.png" />
        </Frame>
      </Accordion>
      <Accordion title="Place a Node" defaultOpen={true}>
        ...
        <Frame>
          <img src="/en/images/quickstart/place-text-generator.png" />
        </Frame>
      </Accordion>
      <Accordion title="Give Instructions to Your Agent" defaultOpen={true}>
        ...
        ```
        <Frame>
          <img src="/en/images/quickstart/give-instructions-to-your-agent.png" />
        </Frame>
      </Accordion>
      <Accordion title="Test Out Your Agent" defaultOpen={true}>
        ...
        <Frame>
          <img src="/en/images/quickstart/run-a-test-drive-of-your-agent.png" />
        </Frame>
        <Frame>
          <img src="/en/images/quickstart/run-a-test-drive-of-your-agent-result.png" />
        </Frame>
      </Accordion>
    </AccordionGroup>
  </Step>
  <Step title="Run the Agent as a Workflow">
    <AccordionGroup>
      <Accordion title="Add Another Node" defaultOpen={true}>
        ...
        <Frame>
          <img src="/en/images/quickstart/add-another-node.png" />
        </Frame>
      </Accordion>
      <Accordion title="Connect the Nodes" defaultOpen={true}>
        ...
        <Frame>
          <img src="/en/images/quickstart/connect-the-nodes.png" />
        </Frame>
      </Accordion>
      <Accordion title="Give Instructions to the Second Node" defaultOpen={true}>
        ...
        ```
        <Frame>
          <img src="/en/images/quickstart/give-instructions-to-the-second-node.png" />
        </Frame>
      </Accordion>
      <Accordion title="Run Your Agent" defaultOpen={true}>
        ...
        <Frame>
          <img src="/en/images/quickstart/run-the-agent-as-a-workflow.png" />
        </Frame>
      </Accordion>
    </AccordionGroup>
  </Step>
