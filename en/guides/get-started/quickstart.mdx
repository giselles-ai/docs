---
title: Quickstart
description: "Build your first AI workflow with Giselle in minutes! This quick start guide covers signup to running a workflow."
---
  ...
  <Step title="Build a Workspace">
    <AccordionGroup>
      <Accordion title="Create a Workspace" defaultOpen={true}>
        Go to the [Workspaces](https://studio.giselles.ai/apps) page and click the "New Workspace" button in the top right to start creating your first Workspace.
      </Accordion>
