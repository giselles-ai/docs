...
<Note>
Member invitations and role management are **Pro Plan** features available to administrators only.
</Note>
...
| Action | Admin | Member |
|--------|-------|--------|
| Invite members | ✓ (Pro Plan only) | ✗ |
| Change other member roles | ✓ (Pro Plan only) | ✗ |
| Change own role | ✗ | ✗ |
...
<Steps>
  <Step title="Open the invite dialog">
    Click the **Invite Member** button (visible only to Pro Plan admins).
  </Step>
...
<Warning>
Each member added to your team will be charged as an additional seat (**$20/seat**) on your Pro Plan subscription.
</Warning>
...
<Note>
Role changes can only be performed by **Pro Plan** administrators.
</Note>
...
<Warning>
Removing a member will immediately revoke all their access to Giselle AI apps. This action cannot be undone.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="Can I invite members on the Free Plan?">
    No, member invitations and role management are Pro Plan features. You need to upgrade to Pro Plan.
  </Accordion>
</AccordionGroup>
