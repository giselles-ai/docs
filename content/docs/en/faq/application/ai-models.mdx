...
- **For coding and complex reasoning**: Claude Opus 4.6, GPT-5.4 or GPT-5.2, Gemini 3.1 Pro Preview or Gemini 2.5 Pro
- **For large context needs**: Claude Sonnet 4.6 or Claude Opus 4.6, GPT-5.4
- **For balanced performance and cost**: Claude Sonnet 4.6 or Claude Sonnet 4.5, Gemini 2.5 Flash
- **For speed and cost-efficiency**: Claude Haiku 4.5, GPT-5-nano, or Gemini 2.5 Flash Lite
- **For image generation**: Gemini 3.1 Flash Image Preview (preview) or Gemini 2.5 Flash Image (stable)
...
- **Anthropic models**: Varies by model. Claude Opus 4.6 and Claude Sonnet 4.6 have 1M tokens; other current Claude models typically have 200k tokens.
- **Google Gemini models**: Most have 1M tokens (may vary by model).
- **OpenAI models**: GPT-5.4 has approximately 1.05M tokens; other GPT-5 series text models typically have 400k tokens.
