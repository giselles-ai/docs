...
**Key models:**
- Claude Opus 4.6 - Most intelligent model for building agents and coding (1M context)
- Claude Opus 4.5 - Advanced coding powerhouse with complex reasoning capabilities
- Claude Sonnet 4.6 - Latest Sonnet model (1M context, balanced)
- Claude Sonnet 4.5 - Balanced high-performance model with latest reasoning features
- Claude Haiku 4.5 - Cost-efficient model with speed and reasoning capabilities (available on Free plan)
...
**Key models:**
- Gemini 3.1 Pro Preview - Upgraded Gemini 3 Pro with SWE/agentic improvements and expanded thinking
- Gemini 3 Flash Preview - Pro-level intelligence at Flash speed and pricing
- Gemini 2.5 Pro - Stable, comprehensive model with multimodal capabilities and web search
- Gemini 2.5 Flash - Speed and reasoning balance
- Gemini 2.5 Flash Lite - Lightweight model for Free plan
- Gemini 3.1 Flash Image Preview - Latest image generation preview model
- Gemini 2.5 Flash Image - Stable image generation and editing model
...
**Key models:**
- GPT-5.4 - Latest model with advanced reasoning options
- GPT-5.3-codex - Latest Codex coding model
- GPT-5.2 - Flagship model for general-purpose tasks
- GPT-5.2-codex - Long-horizon agentic coding model
- GPT-5 - Reliable general-purpose model
- GPT-5-mini - Cost-efficient lightweight model
- GPT-5-nano - Fast, low-cost model available on Free plan
