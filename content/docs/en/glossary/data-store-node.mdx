...
![Workflow example](/en/images/glossary/data-store-node/workflow-example.png)

### Advanced Use Case

By combining with a Generator Node, you can generate SQL from natural language and execute dynamic queries:

![Advanced workflow example](/en/images/glossary/data-store-node/advanced-workflow-example.png)
